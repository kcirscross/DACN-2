...
class Register:
    def __init__(self,root):
        self.root=root
        self.root.title("Registeraton window")
        self.root.geometry("1350x700+0+0")
        self.root.config(bg="white")
        #====bg Image==================
        # note lỗi ở đây,khắc phục ghi rõ đường dẫn file
        ...
        r_name=Label(frame1,text="First Name",font=("times new roman",15,"bold"),bg="white",fg="gray").place(x=50,y=100)
    ...
    # xóa các dòng sau khi nhập vào giá trị mới
    def clear(self):
    ...
    def register_data(self):
        # self.var_fname  textvariable của txt_fname và nút register gọi command=self.register_data để in ra khi nhập từ 
        ...
        if self.txt_fname.get()=="" or self.txt_contact.get()=="" or self.txt_email.get()=="" or self.cmb_quest.get()=="Select" or self.txt_answer.get()=="" or self.txt_password.get()=="" or self.txt_cpassword.get()=="":
            ...
            messagebox.showerror("Error","Password & Confirm Passworld should be same",parent=self.root)
